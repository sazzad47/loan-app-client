    ...
    <>
     ...
     <div id="content-wrapper" class="d-flex flex-column">
      <Box sx={{}} >
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 toptilte" >
                        <h1 class="h3 mb-0 text-gray-800">Current Users</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"   onClick={() => routeNavigate('/admin')}><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Letter</a>
                    </div>
